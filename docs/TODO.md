...
| Item | Status | Source |
|------|--------|--------|
| **Finish video recordings for all FAA Part 107 course content** — record, upload to `media.thedroneedge.com`, set `video_url` on units/sections in course payload, redeploy | **In progress (Aug 12 2026)** — 150 nodes; first 4 Ch.1 videos (`u11`, `u12`, `u131`, `u133`) uploaded, transcoded, and referenced in the repo payload; admin JSON publish still required | User · [`workflows/tech/content-build.md`](../workflows/tech/content-build.md) |
