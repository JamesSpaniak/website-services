...
const maintFindings: Finding[] = [
  { id: "MA2", severity: "high", title: "rebuild_unitN script pattern is unsustainable", location: "scripts/rebuild_unit*.py", detail: "Five one-off scripts hard-code unit content as Python string literals; content lives in three unsynced places (pptx sources, scripts, JSON) and nothing pushes the JSON to the DB. The unit-10 script also silently patches unit 7 as a side effect. Build one parameterized ingestion script + a repo-vs-DB sync tool." },
  ...
  { id: "MA3", severity: "medium", title: "Docs drift from code", location: "docs/exam-generator-and-course-linking.md, course-editing-roadmap.md", detail: "Docs say units 1-9 (unit 10 now exists), question counts are stale, and the roadmap proposes embedded-exam editing that Bundle B removed." },
