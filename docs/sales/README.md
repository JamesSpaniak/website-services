...
Positioning, market research, and contact strategy for school and B2B sales.
...
**Workflows** (how to execute): [`workflows/sales/`](../../workflows/sales/)

| Workflow | Description |
|----------|-------------|
| [outreach.md](../../workflows/sales/outreach.md) | End-to-end school outreach playbook |
| [email-drafts.md](../../workflows/sales/email-drafts.md) | Cold email templates and tone guide |
| [phone-scripts.md](../../workflows/sales/phone-scripts.md) | Cold call, voicemail, discovery openers |
| [delivery-runbook.md](../../workflows/sales/delivery-runbook.md) | Post-close org setup through launch |
