...
| [`../assets/courses/faa-107/questions/faa_107_questions_gaps.md`](../assets/courses/faa-107/questions/faa_107_questions_gaps.md) | Part 107 import stats, sub-unit coverage, import risks |
| [`../assets/courses/faa-107/questions/faa_107_general_operations_review.csv`](../assets/courses/faa-107/questions/faa_107_general_operations_review.csv) | 167 rows: spreadsheet K/L cleanup for content team |
...
Course outline lives in **`courses.payload`** (`CourseDetails` JSON), e.g. `assets/courses/faa-107/faa_107_course.json` for Part 107 (course id **35**).
...
**Part 107 import artifact:** `assets/courses/faa-107/questions/faa_107_questions.bulk.json` (461 unique questions from Testing CSVs). Regenerate with `python3 scripts/build_faa_107_questions.py`.
...
2. Deploy backend.
3. **Bundle A:** Import `assets/courses/faa-107/questions/faa_107_questions.bulk.json` (admin UI or API).
