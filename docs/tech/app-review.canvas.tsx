...
const frontendFindings: Finding[] = [
  ...
  { id: "U4", severity: "medium", title: "Completion is manual and hidden behind an unlabeled kebab per node", location: "unit.tsx, mark-complete-bar.tsx", detail: "Shipped Sep 15 2026: leaf 'Mark complete & continue'; passing a scoped quiz (≥70) auto-completes that unit. Kebab remains for revert. Admin funnel 'Quiz passed' is the honest finish signal." },
