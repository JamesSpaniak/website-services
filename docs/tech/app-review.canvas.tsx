...
const maintFindings: Finding[] = [
  { id: "MA2", severity: "medium", title: "rebuild_unitN scripts removed", location: "assets/courses/faa_107_course.json", detail: "Former one-off rebuild_unit*.py scripts deleted; course JSON is the single source. Still need a parameterized outline→JSON ingest and repo-vs-DB sync tool." },
