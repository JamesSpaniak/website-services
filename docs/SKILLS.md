...
| Drone-building course outline (v3) | [`assets/courses/drone-building/outlines/drone-building-course-outline-v3.md`](../assets/courses/drone-building/outlines/drone-building-course-outline-v3.md) | Draft from v3; rationale in `drone-building-course-review-v2.md`; no payload or catalog track |
