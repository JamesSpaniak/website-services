...
| Drone-building course outline (v2 review + Joe's source) | [`assets/courses/drone-building/outlines/drone-building-course-review-v2.md`](../assets/courses/drone-building/outlines/drone-building-course-review-v2.md) | Author intake only — no payload or catalog track; source of truth `joe-drone-build-feedback-v2.md` |
